...
class KSEGBase(Dataset):
    ...
    def __getitem__(self, i):
        ...
        segmentation = Image.fromarray(cv2.cvtColor(cv2.imread(example["file_path_"].replace("images", "LesionSegmentationClass1")),cv2.COLOR_BGR2RGB))
...
class PlantTrain(KSEGBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="data/plant/JPEGImages", mode="train", **kwargs)


class PlantValidation(KSEGBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="data/plant/JPEGImages", mode="val", **kwargs)


class PlantTest(KSEGBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="data/plant/JPEGImages", mode="test", **kwargs)
